    ...
    <MainLayout title="Lesson Plan Generator">
      ...
      <div className="max-w-7xl mx-auto w-full px-0 sm:px-4 md:px-8">
        ...
        <div className="mb-4 md:mb-8 px-3 sm:px-0">
          <h2 className="text-lg md:text-3xl font-extrabold font-display tracking-tight text-on-surface mb-1 md:mb-2">Lesson Plan Generator</h2>
          <p className="text-on-surface-variant font-medium font-body text-3xs md:text-base">Design comprehensive, curriculum-aligned lesson plans and assessments in seconds with AI-driven insights.</p>
        </div>
            ...
            <div className="bg-surface-container-lowest p-3 md:p-6 rounded-lg md:rounded-2xl shadow-sm border border-outline-variant/10">
              ...
              <form className="space-y-3 md:space-y-4">
                ...
                <div className="flex flex-col gap-1 md:gap-1.5 mb-3 md:mb-4">
                  <label className="text-3xs md:text-xs font-bold text-on-surface-variant px-1 uppercase tracking-wider font-display">Lesson Duration (mins)</label>
                  <input
                    value={lessonDuration}
                    type="number"
                    onChange={(e) => setLessonDuration(e.target.value)}
                    placeholder="e.g., 60"
                    className="bg-surface-container-low border-none rounded-md py-2 md:py-3 px-3 md:px-4 text-2xs md:text-sm focus:ring-2 focus:ring-primary/40 outline-none font-body"
                    min="15"
                    max="180"
                  />
                </div>
                ...
                <div className="pt-3 md:pt-4 space-y-3 md:space-y-4 border-t border-outline-variant/15">
                  ...
                  <div className="flex flex-col gap-2 md:gap-3">
                    <div className="flex items-center justify-between">
                      <span className="text-2xs md:text-sm font-medium text-on-surface font-body">Map Next Generation Standards</span>
            ...
            <div className={`bg-surface-container-lowest shadow-sm flex flex-col h-full border border-outline-variant/10 ${isFullscreen ? 'fixed inset-0 z-50 rounded-none overflow-y-auto w-full' : 'rounded-xl md:rounded-2xl overflow-hidden min-h-[400px] md:min-h-[600px]'}`}>
              <div className="bg-surface-container-high p-3 md:p-4 flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-bold font-display text-on-surface text-sm md:text-base">Lesson Plan Preview</span>
                </div>
